    		...
    		<h5>Room Information</h5>
  			...
  			<div class="form-row">
	    		<div class="form-group col-md-6">
	      			<label>Room No</label>
	     			<input name="room_number" type="text" class="form-control" placeholder="Room no">
	    		</div>
	   			<div class="form-group col-md-6">
	     			<label for="inputPassword4">Seater</label>
	      			<input name="seater" type="text" class="form-control" placeholder="Seater">
	    		</div>
  			</div>
  				<div class="form-group">
  					<label for="inputAddress">Fees per month</label>
   					<input name="fees_per_month" type="text" class="form-control" placeholder="Enter amount">
  				</div>
