...
<head>
	...
	<body>
		<div class="container-fluid">
			...
			<form action="insertActionStaff.php" method="post" style="margin-bottom: 40px;">
	    		<h5>Staff Information</h5>

		  		<div class="form-row">
			  		<div class="form-group col-md-6">
			     		 <label for="inputEmail4">First Name</label>
			      		<input name="first_name" type="text" class="form-control" id="inputEmail4" placeholder="first name">
			    	</div>
			    	<div class="form-group col-md-6">
			      		<label for="inputPassword4">Last Name</label>
			      		<input name="last_name" type="text" class="form-control" id="inputPassword4" placeholder="last name">
			   		</div>
		 		</div>
		 			<div class="form-group">
		    			<label for="inputAddress">Contact Number</label>
		   				<input name="contact_number" type="text" class="form-control" id="inputAddress" placeholder="contact number">
		 			 </div>
		  			<div class="form-group">
		 			...
		 			<div class="form-group">
		  			    <label for="inputAddress">Salary</label>
		   				<input name="salary" type="text" class="form-control" id="inputAddress" placeholder="salary">
		  			</div>
